...
{
    [CustomGridBrush(true, false, false, "Closet")]
    public class ClosetBrush : GridBrush
    {
        Transform tilemap;

        string prefabPath = "Assets/Prefabs/Closet.prefab";
        string parentGameObjectName = "Closets";
        ...
        public override void Paint(GridLayout gridLayout, GameObject brushTarget, Vector3Int position)
        {
            ...
            obj.transform.position = new Vector3(obj.transform.position.x, obj.transform.position.y, obj.transform.position.z); // Technique de sioux
