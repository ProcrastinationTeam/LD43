...
{
    [CustomGridBrush(true, false, false, "ChildBed")]
    public class ChildBedBrush : GridBrush
    {
        Transform tilemap;

        string prefabPath = "Assets/Prefabs/ChildBed.prefab";
        string parentGameObjectName = "Beds";
        ...
        public override void Paint(GridLayout gridLayout, GameObject brushTarget, Vector3Int position)
        {
            ...
            obj.transform.position = new Vector3(obj.transform.position.x + 1, obj.transform.position.y + 1, obj.transform.position.z); // Technique de sioux
